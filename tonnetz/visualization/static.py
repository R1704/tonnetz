...
class TonnetzPlotter:
    ...
    def plot_tonnetz_lattice(
        self,
        tonnetz: ToroidalTonnetz,
        chords: Optional[List[Chord]] = None,
        title: str = "Tonnetz Lattice",
        save_path: Optional[str] = None,
        show: bool = True,
    ) -> plt.Figure:
        """
    ...
    def plot_grid_animation_frames(
        self,
        grid: ToroidalGrid,
        rule_func,
        num_frames: int = 10,
        ...
        for frame in range(num_frames):
            ...
            self.plot_grid(
                grid,
                title=f"Generation {grid.generation}",
