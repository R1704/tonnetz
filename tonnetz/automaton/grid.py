...
class ToroidalGrid:
    ...
    def __init__(self, width: int, height: int, 
                 ...
                 update_mode: str = 'synchronous') -> None:
        """
    ...
    def get_neighbor_distances(self, x: int, y: int) -> List[float]:
        ...
        if self.neighborhood == 'moore':
            ...
            distances = [1.414, 1.0, 1.414, 1.0, 1.0, 1.414, 1.0, 1.414]  # sqrt(2) for diagonals
        elif self.neighborhood == 'von_neumann':
    ...
    def populate_random(self, chord_generator: Optional[Callable[[], Chord]] = None) -> None:
        """
    ...
    def populate_with_progression(self, progression_algo: ProgressionAlgo, 
                                start_chord: Optional[Chord] = None) -> None:
        """
    ...
    def _apply_rule_synchronous(self, rule_func: Callable[[Cell, List[Cell]], Chord]) -> None:
    ...
    def _apply_rule_asynchronous(self, rule_func: Callable[[Cell, List[Cell]], Chord]) -> None:
    ...
    def update(self, rule_func: Optional[Callable[[Cell, List[Cell]], Chord]] = None) -> None:
        """
        ...
        if rule_func is None:
            ...
            def majority_rule(cell: Cell, neighbors: List[Cell]) -> Chord:
                ...
                most_common = [chord for chord, count in chord_counts.items() 
                             if count == max_count]
    ...
    def _update_statistics(self) -> None:
        ...
        self.stats['harmony_level'] = harmony_sum / cell_count if cell_count > 0 else 0.0
            ...
            for x in range(self.width - pattern_size + 1):
                ...
                for y2 in range(y + 1, self.height - pattern_size + 1):
                    for x2 in range(self.width - pattern_size + 1):
                        ...
                        other_pattern = state_matrix[y2:y2+pattern_size, x2:x2+pattern_size]
